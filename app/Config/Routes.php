...
$routes->group('admin', ['filter' => 'auth'], function ($routes) {
    ...
    /** Routing Ke Halaman Asrama */
    $routes->add('dashboard', 'Admin\Dashboard::index');
    $routes->add('asrama', 'Admin\Asrama::index');
    $routes->add('asrama/tambah', 'Admin\Asrama::tambah');
    $routes->add('asrama/edit/(:segment)', 'Admin\Asrama::edit/$1');

    /** Routing Ke Halaman Artikel */
    $routes->add('dashboard', 'Admin\Dashboard::index');
    $routes->add('article', 'Admin\Article::index');
    $routes->add('article/tambah', 'Admin\Article::tambah');
    $routes->add('article/edit/(:segment)', 'Admin\Article::edit/$1');

    /** Routing Ke Halaman Page */
    $routes->add('page', 'Admin\Page::index');
    $routes->add('page/tambah', 'Admin\Page::tambah');
    $routes->add('page/edit/(:segment)', 'Admin\Page::edit/$1');
