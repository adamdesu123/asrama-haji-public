...
?>
    ...
    <div class="mb-3">
        <label for="input_password_lama" class="form-label">Masukkan Password Yang Lama</label>
        <input type="password" class="form-control" id="input_password_lama" name="password_lama">
    </div>

    <div class="mb-3">
        <label for="input_password_baru" class="form-label">Masukkan Password Yang Baru</label>
        <input type="password" class="form-control" id="input_password_baru" name="password_baru">
    </div>

    <div class="mb-3">
        <label for="input_password_baru_konfirmasi" class="form-label">Konfirmasi Password Yang Baru</label>
